...
public class ConexionDefault {
    ...
    private final String DB="conexion";
    private final String URL="jdbc:mysql://192.168.1.25:3306/"+DB+"?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
